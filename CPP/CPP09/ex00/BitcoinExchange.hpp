...
class BitcoinExchange
{
    private:
        ...
        std::map <std::string, double>    get_database(char const * filename, char delimiter);
    ...
    public:
        ...
        void    processInput(char const * inputFile);
        double  get_exchange_rate(std::string const & date) const;
};
